...
class Ui_MainFormPancake3D(object):
    def setupUi(self, MainFormPancake3D):
        ...
        MainFormPancake3D.resize(420, 500)
        ...
        MainFormPancake3D.setMinimumSize(QtCore.QSize(420, 500))
        ...
        self.chk_compare_lorensen = QtWidgets.QCheckBox(MainFormPancake3D)
        self.chk_compare_lorensen.setWhatsThis("")
        self.chk_compare_lorensen.setObjectName("chk_compare_lorensen")
        self.horizontalLayout_6.addWidget(self.chk_compare_lorensen)
    ...
    def retranslateUi(self, MainFormPancake3D):
        ...
        self.label_4.setText(_translate("MainFormPancake3D", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:700;\">Debug</span></p></body></html>"))
        ...
        self.chk_compare_lorensen.setToolTip(_translate("MainFormPancake3D", "Add a column in the output CSV of the surface area as predicted by the Lorensen 1987 (Marching Cubes) algorithm"))
        self.chk_compare_lorensen.setText(_translate("MainFormPancake3D", "Compare area to Lorensen 1987"))
