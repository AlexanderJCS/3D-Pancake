...
class Ui_MainFormPancake3D(object):
    def setupUi(self, MainFormPancake3D):
        ...
        MainFormPancake3D.resize(420, 475)
        ...
        MainFormPancake3D.setMinimumSize(QtCore.QSize(420, 475))
        ...
        self.label_vertex_deletion_threshold = QtWidgets.QLabel(MainFormPancake3D)
        self.label_vertex_deletion_threshold.setObjectName("label_vertex_deletion_threshold")
        self.horizontalLayout.addWidget(self.label_vertex_deletion_threshold)
        self.line_edit_vertex_deletion_threshold = QtWidgets.QLineEdit(MainFormPancake3D)
        self.line_edit_vertex_deletion_threshold.setObjectName("line_edit_vertex_deletion_threshold")
        self.horizontalLayout.addWidget(self.line_edit_vertex_deletion_threshold)
    ...
    def retranslateUi(self, MainFormPancake3D):
        ...
        self.line_edit_c_s.setText(_translate("MainFormPancake3D", "0.3"))
